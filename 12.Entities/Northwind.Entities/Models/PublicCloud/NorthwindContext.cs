...
namespace Northwind.Entities.Models.PublicCloud
{
    public partial class NorthwindContext : DbContext
    {
        ...
        // Unable to generate entity type for table 'dbo.NLog_Error'. Please see the warning messages.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AuthTokens>(entity =>
            {
                ...
                entity.HasOne(d => d.Account)
                    ...
                    .HasConstraintName("FK_AuthTokens_Accounts");

                entity.HasOne(d => d.AccountNavigation)
                    .WithMany(p => p.AuthTokens)
                    .HasForeignKey(d => d.AccountId)
                    .HasConstraintName("FK_AuthTokens_Employees");
            });

            modelBuilder.Entity<Authorizes>(entity =>
            {
                ...
                entity.Property(e => e.AuthorizationType).HasMaxLength(20);
            ...
            modelBuilder.Entity<Employees>(entity =>
            {
                ...
                entity.HasOne(d => d.Authorization)
                    ...
                    .HasConstraintName("FK_Employees_Authorizes");
